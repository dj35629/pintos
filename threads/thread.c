...
static int64_t tiempo_dormido;

struct list lista_espera;
...
/*FUNCION AGREGADA PARA IMPLEMENTAR LA LISTA DE ESPERA*/
...
/*FUNCION AGREGADA PARA SACAR UN THREAD DE LA COLA DE ESPERA*/
